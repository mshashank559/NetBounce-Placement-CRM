              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    {(role === 'LEAD_TL' || role === 'ADMIN' || role === 'SALES_TL') && <th className="text-left p-3 font-medium text-muted-foreground">Assigned To</th>}
                  ...
                  {filtered.map((lead, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* ── Assigned To ── */}
                        {(role === 'LEAD_TL' || role === 'ADMIN' || role === 'SALES_TL') && (
                          <td className="p-3">
