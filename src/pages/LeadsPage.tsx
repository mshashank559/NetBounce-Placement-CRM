...
const LeadsPage: React.FC = () => {
  ...
  // ── Fetch closure data (for Admin view of payments) ────────────
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    {role === 'ADMIN' && <th className="text-left p-3 font-medium text-muted-foreground">Assigned To</th>}
                    ...
                    {role === 'ADMIN' && <th className="text-left p-3 font-medium text-muted-foreground">Payment</th>}
                            ...
                            {lead.assigned_to ? (
                              <div>
                                <p className="text-xs font-medium text-primary">
                                  {profilesMap?.[lead.assigned_to]?.full_name || 'Unknown'}
                                </p>
                                {lead.team_lead_id && (
                                  <p className="text-[10px] text-muted-foreground">
                                    via {profilesMap?.[lead.team_lead_id]?.full_name || 'Unknown TL'}
                                  </p>
                                )}
                              </div>
                            ) : lead.team_lead_id ? (
                              <div>
                                <p className="text-xs font-medium text-muted-foreground italic">Unassigned</p>
                                <p className="text-[10px] text-muted-foreground">
                                  TL: {profilesMap?.[lead.team_lead_id]?.full_name || 'Unknown TL'}
                                </p>
                              </div>
                            ) : (
