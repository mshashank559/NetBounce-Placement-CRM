            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border">
                  {['ID', 'Date', 'Name', 'Email', 'Phone', 'LinkedIn', 'Uni', 'Tech', 'Source', 'Generated By', 'Category', 'Status', 'Assigned To', 'Last Activity', 'Comment', 'DNR Follow-up', 'Actions'].map(h => (
              ...
              <tbody>
                {filteredLeads.length === 0 ? (
                  <tr><td colSpan={17} className="text-center py-8 text-muted-foreground">No leads found. Start by adding leads!</td></tr>
